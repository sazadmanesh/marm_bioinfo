...
# Metadata
```{r}
readRDS(file = "data/metadata.rds")
```
...
```
```{r}
saveRDS(dataset.main, "data/dataset_main.rds")
saveRDS(dataset.g1, "data/dataset_group1.rds")
saveRDS(dataset.g2, "data/dataset_group2.rds")
saveRDS(dataset.int, "data/dataset_intervention.rds")
saveRDS(dataset.lsk, "data/dataset_ligation.rds")
saveRDS(dataset.rap, "data/dataset_rapid.rds")
saveRDS(dataset.rap.g1, "data/dataset_rapid_group1.rds")
saveRDS(dataset.rap.g2, "data/dataset_rapid_group2.rds")
saveRDS(dataset.rap.int, "data/dataset_rapid_intervention.rds")
```
...
```
```{r}
saveRDS(phy.main, "data/phy_main.rds")
saveRDS(phy.g1, "data/phy_group1.rds")
saveRDS(phy.g2, "data/phy_group2.rds")
saveRDS(phy.int, "data/phy_intervention.rds")
```
### Class
```{r}
...
```
```{r}
saveRDS(cla.main, "data/cla_main.rds")
saveRDS(cla.g1, "data/cla_group1.rds")
saveRDS(cla.g2, "data/cla_group2.rds")
saveRDS(cla.int, "data/cla_intervention.rds")
```
### Order
```{r}
...
```
```{r}
saveRDS(ord.main, "data/ord_main.rds")
saveRDS(ord.g1, "data/ord_group1.rds")
saveRDS(ord.g2, "data/ord_group2.rds")
saveRDS(ord.int, "data/ord_intervention.rds")
```
### Family
```{r}
...
```
```{r}
saveRDS(fam.main, "data/fam_main.rds")
saveRDS(fam.g1, "data/fam_group1.rds")
saveRDS(fam.g2, "data/fam_group2.rds")
saveRDS(fam.int, "data/fam_intervention.rds")
```
### Genus
```{r}
...
```
```{r}
saveRDS(gen.main, "data/gen_main.rds")
saveRDS(gen.g1, "data/gen_group1.rds")
saveRDS(gen.g2, "data/gen_group2.rds")
saveRDS(gen.int, "data/gen_intervention.rds")
```
