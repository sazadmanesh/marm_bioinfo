...
marm_foods <- list(
  ...
  tab_header(title = "Table 2",
             subtitle = "Standardized Diet per Marmoset Pair") %>%
...
marm_pred <- list(
  "Increase" = list(
    "Anaerobiospirillum",
    "Decreased in MDDS",
    "Artim et al., 2019; Sheh et al., 2022"
  ),
  "Increase" = list(
    "Bifidobacterium",
    "Decreased in chronic diarrhea and gut dysbiosis",
    "Hayer et al., 2024; Shigeno et al., 2018"
  ),
  "Decrease" = list(
    "Fusobacterium",
    "Increased in gut dysbiosis and MWS",
    "Bakker et al., 2025; Hayer et al., 2024"
  ),
  "Increase" = list(
    "Megasphaera",
    "Decreased in dysbiosis and shifts associated with IBD",
    "Hayer et al., 2024; Sheh et al., 2022"
  ),
  "Decrease" = list(
    "Prevotella",
    "Increased in MWS and IBD",
    "Cooper et al., 2019; Sheh et al., 2022"
  )
) %>%
  enframe(name = "Prediction", value = "Details") %>%
  unnest_wider(Details, names_sep = "_") %>%
  rename(Taxa = Details_1, Significance = Details_2, References = Details_3) %>%
  ...
  tab_header("Table X: Hypothesis Predictions") %>%
