...
dataset.g1 <- read.microtable("tax", "g1")
dataset.g2 <- read.microtable("tax", "g2")
...
keg.g1 <- read.f.microtable("function", "keg", "g1")
keg.g2 <- read.f.microtable("function", "keg", "g2")
keg.baseline <- read.f.microtable("function", "keg", "baseline")
keg.gum <- read.f.microtable("function", "keg", "gum")
keg.control <- read.f.microtable("function", "keg", "control")
keg.controlwash <- read.f.microtable("function", "keg", "controlwash")
...
fpt.g1 <- read.f.microtable("function", "fpt", "g1")
fpt.g2 <- read.f.microtable("function", "fpt", "g2")
fpt.baseline <- read.f.microtable("function", "fpt", "baseline")
fpt.gum <- read.f.microtable("function", "fpt", "gum")
fpt.control <- read.f.microtable("function", "fpt", "control")
fpt.controlwash <- read.f.microtable("function", "fpt", "controlwash")
...
njc.g1 <- read.f.microtable("function", "njc", "g1")
njc.g2 <- read.f.microtable("function", "njc", "g1")
njc.baseline <- read.f.microtable("function", "njc", "baseline")
njc.gum <- read.f.microtable("function", "njc", "gum")
njc.control <- read.f.microtable("function", "njc", "control")
njc.controlwash <- read.f.microtable("function", "njc", "controlwash")
njc.gumwash <- read.f.microtable("function", "njc", "gumwash")
njc.int <- read.f.microtable("function", "njc", "int")
```
...
bray.int$plot_group_distance(add = "mean")
```
```{r}
