...
# Alignment Files
```{r}
alignment.files.list <- list.files(path = "data/read_alignments/",
                                   pattern = "*_wf-metagenomics-alignment.csv$",
                                   full.names = TRUE)

alignment.filenames <- list.files(path = "data/read_alignments/",
                                   pattern = "*_wf-metagenomics-alignment.csv$",
                                   full.names = FALSE)
...
```
```{r}
dataset.main$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.g1$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.g2$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.baseline$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.gum$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.gumwash$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.control$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.controlwash$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.int$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.ne$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.tx$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.rmb$rarefy_samples(method = "SRS", sample.size = 4000)
dataset.rmf$rarefy_samples(method = "SRS", sample.size = 4000)
```
...
```
```{r}
dataset.rmf$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
...
dataset.tx$save_betadiv("microeco/betadiversity/texas")
