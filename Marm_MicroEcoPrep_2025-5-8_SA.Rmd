---
title: "Marm_MicroecoPrep_2025-5-8_SA"
author: "Shayda"
date: "`r Sys.Date()`"
params:
...
here::i_am("Marm_MicroecoPrep_2025-5-8_SA.Rmd")
...
metadata <- read.table(marmoset$compilation,
                       header = T, 
                       sep = "\t")
```
## Metadata Subsets
...
# Alignment Files
```{r}
alignment.files.list <- list.files(path = marmoset$barcode_alignments,
                                   pattern = "*_wf-metagenomics-alignment.csv$",
                                   full.names = TRUE)

alignment.filenames <- list.files(path = marmoset$barcode_alignments,
                                   pattern = "*_wf-metagenomics-alignment.csv$",
                                   full.names = FALSE)
...
```{r}
tax.tree <- read.tree("data/taxonomy/refseqs_tree.newick")
rep.seqs <- read.fasta("data/taxonomy/refseqs_aligned.fasta")
...
write.table(sample.table, "data/metadata")
```
# Sample Subsets
```{r}
...
write.table(sample.table.merged, "data/metadata")
...
```
```{r}
dataset.main$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.g1$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.g2$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.baseline$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.gum$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.gumwash$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.control$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.controlwash$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.int$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.ne$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.tx$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.rmb$rarefy_samples(method = "SRS", sample.size = 4500)
dataset.rmf$rarefy_samples(method = "SRS", sample.size = 4500)
```
...
```
```{r}
dataset.main$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.g1$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.g2$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.baseline$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.gum$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.gumwash$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.control$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.controlwash$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.int$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.ne$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.tx$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.rmb$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
dataset.rmf$filter_taxa(rel_abund = 0.00001,
                         freq = 1,
                         include_lowest = TRUE)
```
# Diversity
```{r}
dataset.main$cal_alphadiv(PD = TRUE)
dataset.g1$cal_alphadiv(PD = TRUE)
dataset.g2$cal_alphadiv(PD = TRUE)
dataset.baseline$cal_alphadiv(PD = TRUE)
dataset.gum$cal_alphadiv(PD = TRUE)
dataset.gumwash$cal_alphadiv(PD = TRUE)
dataset.control$cal_alphadiv(PD = TRUE)
dataset.controlwash$cal_alphadiv(PD = TRUE)
dataset.int$cal_alphadiv(PD = TRUE)
dataset.ne$cal_alphadiv(PD = TRUE)
dataset.tx$cal_alphadiv(PD = TRUE)
dataset.rmb$cal_alphadiv(PD = TRUE)
dataset.rmf$cal_alphadiv(PD = TRUE)

dataset.main$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.g1$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.g2$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.baseline$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.gum$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.gumwash$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.control$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.controlwash$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.int$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.ne$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.tx$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.rmb$cal_betadiv(unifrac = TRUE,
                         method = "aitchison")
```
```{r}
dataset.rmb$cal_betadiv(unifrac = TRUE,
...
```
```{r}
dataset.main$save_table("microeco/datasets/dataset_main", sep = "\t")
dataset.g1$save_table("microeco/datasets/dataset_group1", sep = "\t")
dataset.g2$save_table("microeco/datasets/dataset_group2", sep = "\t")
dataset.baseline$save_table("microeco/datasets/dataset_baseline", sep = "\t")
dataset.gum$save_table("microeco/datasets/dataset_gum", sep = "\t")
dataset.gumwash$save_table("microeco/datasets/dataset_gumwash", sep = "\t")
dataset.control$save_table("microeco/datasets/dataset_control", sep = "\t")
dataset.controlwash$save_table("microeco/datasets/dataset_controlwash", sep = "\t")
dataset.int$save_table("microeco/datasets/dataset_intervention", sep = "\t")
dataset.tx$save_table("microeco/datasets/dataset_texas", sep = "\t")
dataset.ne$save_table("microeco/datasets/dataset_nebraska", sep = "\t")
dataset.rmb$save_table("microeco/datasets/dataset_roomb", sep = "\t")
dataset.rmf$save_table("microeco/datasets/dataset_roomf", sep = "\t")


dataset.main$save_abund("microeco/abundance/main", sep = "\t")
dataset.g1$save_abund("microeco/abundance/group1", sep = "\t")
dataset.g2$save_abund("microeco/abundance/group2", sep = "\t")
dataset.baseline$save_abund("microeco/abundance/baseline", sep = "\t")
dataset.gum$save_abund("microeco/abundance/gum", sep = "\t")
dataset.gumwash$save_abund("microeco/abundance/gumwash", sep = "\t")
dataset.control$save_abund("microeco/abundance/control", sep = "\t")
dataset.controlwash$save_abund("microeco/abundance/controlwash", sep = "\t")
dataset.int$save_abund("microeco/abundance/intervention", sep = "\t")
dataset.tx$save_abund("microeco/abundance/texas", sep = "\t")
dataset.ne$save_abund("microeco/abundance/nebraska", sep = "\t")
dataset.rmb$save_abund("microeco/abundance/roomb", sep = "\t")
dataset.rmf$save_abund("microeco/abundance/roomf", sep = "\t")

dataset.main$save_alphadiv("microeco/alphadiversity/main")
dataset.g1$save_alphadiv("microeco/alphadiversity/group1")
dataset.g2$save_alphadiv("microeco/alphadiversity/group2")
dataset.baseline$save_alphadiv("microeco/alphadiversity/baseline")
dataset.gum$save_alphadiv("microeco/alphadiversity/gum")
dataset.gumwash$save_alphadiv("microeco/alphadiversity/gumwash")
dataset.control$save_alphadiv("microeco/alphadiversity/control")
dataset.controlwash$save_alphadiv("microeco/alphadiversity/controlwash")
dataset.int$save_alphadiv("microeco/alphadiversity/intervention")
dataset.tx$save_alphadiv("microeco/alphadiversity/texas")
dataset.ne$save_alphadiv("microeco/alphadiversity/nebraska")
dataset.rmb$save_alphadiv("microeco/alphadiversity/roomb")
dataset.rmf$save_alphadiv("microeco/alphadiversity/roomf")

dataset.main$save_betadiv("microeco/betadiversity/main")
dataset.g1$save_betadiv("microeco/betadiversity/group1")
dataset.g2$save_betadiv("microeco/betadiversity/group2")
dataset.baseline$save_betadiv("microeco/betadiversity/baseline")
dataset.gum$save_betadiv("microeco/betadiversity/gum")
dataset.gumwash$save_betadiv("microeco/betadiversity/gumwash")
dataset.control$save_betadiv("microeco/betadiversity/control")
dataset.controlwash$save_betadiv("microeco/betadiversity/controlwash")
dataset.int$save_betadiv("microeco/betadiversity/intervention")
dataset.tx$save_betadiv("microeco/betadiversity/texasx")
dataset.ne$save_betadiv("microeco/betadiversity/nebraska")
dataset.rmb$save_betadiv("microeco/betadiversity/roomb")
dataset.rmf$save_betadiv("microeco/betadiversity/roomf")
```
# Functional Profiles
## KEGG
```{r}
