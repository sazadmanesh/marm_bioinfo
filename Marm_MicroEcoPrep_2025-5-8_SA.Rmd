...
subjects <- read.table("metadata/marm_subjects.tsv",
                      ...
                      sep = "\t") %>%
  mutate(
    location = factor(cage, levels = unique(cage)),
...
metadata <- libraries %>%
  ...
  mutate(room = str_glue("room {str_extract(cage, '^[a-zA-Z]')}"))
```
## Metadata Subsets
# Sample Subsets
```{r}
...
dataset.g1$save_table("microeco/datasets/dataset_g1", sep = "\t")
dataset.g2$save_table("microeco/datasets/dataset_g2", sep = "\t")
...
dataset.tx$save_table("microeco/datasets/dataset_tx", sep = "\t")
dataset.ne$save_table("microeco/datasets/dataset_ne", sep = "\t")
...
dataset.g1$save_abund("microeco/abundance/g1", sep = "\t")
dataset.g2$save_abund("microeco/abundance/g2", sep = "\t")
...
dataset.tx$save_abund("microeco/abundance/tx", sep = "\t")
dataset.ne$save_abund("microeco/abundance/ne", sep = "\t")
...
dataset.g1$save_alphadiv("microeco/alphadiversity/g1")
dataset.g2$save_alphadiv("microeco/alphadiversity/g2")
...
dataset.tx$save_alphadiv("microeco/alphadiversity/tx")
dataset.ne$save_alphadiv("microeco/alphadiversity/ne")
...
dataset.g1$save_betadiv("microeco/betadiversity/g1")
dataset.g2$save_betadiv("microeco/betadiversity/g2")
...
dataset.tx$save_betadiv("microeco/betadiversity/tx")
dataset.ne$save_betadiv("microeco/betadiversity/ne")
