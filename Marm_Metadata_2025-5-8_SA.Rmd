...
write.table(samples,
            ...
            row.names = FALSE,
            sep = "\t")
write.csv(samples, marmoset$samples_csv, row.names = FALSE)
```
```{r}
...
write.table(samples,
            ...
            row.names = FALSE,
            sep = "\t")
write.csv(extracts, marmoset$extracts_csv, row.names = FALSE)
...
write.table(samples,
            ...
            row.names = FALSE,
            sep = "\t")
write.csv(libraries, marmoset$libraries_csv, row.names = FALSE)
...
write.table(samples,
            ...
            row.names = FALSE,
            sep = "\t")
write.csv(seqruns, marmoset$seqruns_csv, row.names = FALSE)
...
write.table(samples,
            ...
            row.names = FALSE,
            sep = "\t")
write.csv(subjects, marmoset$subjects_csv, row.names = FALSE)
...
write.table(samples,
            marmoset$compilation,
            row.names = FALSE,
            sep = "\t")
```
```{r}
bristol <- read.table("metadata/marm_bristol.tsv",
                      header = T,
                      sep = "\t")
```