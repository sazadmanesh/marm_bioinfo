---
title: "Marm_MicroEco_2025-5-4_SA"
author: "Shayda"
date: "`r Sys.Date()`"
...
here::i_am("Marm_Microeco_2025-5-4_SA.Rmd")
...
dataset.ne <- read.microtable("tax", "ne")
dataset.tx <- read.microtable("tax", "tx")
dataset.rmb <- read.microtable("tax", "roomb")
dataset.rmf <- read.microtable("tax", "roomf")
